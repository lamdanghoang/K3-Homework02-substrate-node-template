...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		kitties: KittiesConfig {
			kitties: vec![
				(get_account_id_from_seed::<sr25519::Public>("Alice"), b"Tom".to_vec()),
				(get_account_id_from_seed::<sr25519::Public>("Alice"), b"Jerry".to_vec()),
				(get_account_id_from_seed::<sr25519::Public>("Alice"), b"John".to_vec()),
			],
			// time: duration_now(),
		},
	}
